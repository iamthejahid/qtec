...
// ignore_for_file: no_leading_underscores_for_local_identifiers, inference_failure_on_instance_creation, inference_failure_on_function_return_type, type_annotate_public_apis, always_declare_return_types, inference_failure_on_function_invocation
...
class CleanFailure extends Equatable {
  ...
  factory CleanFailure.withData({
    ...
    final _tag = tag == 'Type' ? url : tag;
    final _errorMap = <String, dynamic>{
      'url': url,
      'method': method,
    ...
    final _errorStr = encoder.convert(_errorMap);
    return CleanFailure(
      tag: _tag,
      error: _errorStr,
...
class CleanFailureDialogue extends StatelessWidget {
        ...
        ElevatedButton(
          ...
          onPressed: () {
            ...
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => CleanFailureDetailsPage(failure: failure),
              ),
            );
          },
  ...
  static void show(BuildContext context, {required CleanFailure failure}) {
...
class CleanFailureDetailsPage extends StatelessWidget {
  const CleanFailureDetailsPage({required this.failure, super.key});
  final CleanFailure failure;
